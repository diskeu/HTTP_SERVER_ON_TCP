...
class HTTP_Server():
    ...
    def Form_Handler(self, form_Body:str) -> dict:
        ...
        print(f"splited_Form_Elements {splited_Form_Elements}")
            ...
            if asyncio.iscoroutinefunction(handler):
                if body_Needed:
                    ...
                    if easy_Form_Handler:
                        asyncio.run(handler(self.Form_Handler(body)))
...
myServer.add_Route(path="/slow", handler=slow, method_defined="GET", body_Needed=True, easy_Form_Handler=False)
